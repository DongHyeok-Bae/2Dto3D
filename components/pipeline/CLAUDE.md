...
## 📌 목적
Phase 1-7 AI 파이프라인 실행 및 진행 상황 표시
...
{
  imageBase64,
  previousResults: { phase1-5 }
}

// Phase 7
POST /api/pipeline/phase7
{
  allResults: { phase1-6 }
}
```
...
3. Phase 3-5 순차 실행
4. Phase 6 검증 (Phase 1-5 결과 종합)
5. Phase 7 Master JSON 생성
